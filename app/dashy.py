...
#     # POR ESTO: ver aqui cambios
#     html.Div(id="resultado", className="resultado", style={"display": "none"}),#
# # Botones "invisibles" para que los callbacks puedan encontrarlos al inicio
#     html.Div(style={"display": "none"}, children=[
#         html.Button(id="nueva-prediccion", n_clicks=0),
#         html.Button(id="finalizar-prediccion", n_clicks=0),
# ]),
...
#     html.Div(mensaje, className="mensaje-resultado"),
#     html.Div([
#         # ↓↓↓ CAMBIO AQUÍ: IDs NUEVOS CON SUFIJO ↓↓↓
#         html.Button("Realizar una nueva predicción", id="nueva-prediccion-visible", n_clicks=0, className="btn-accion", 
#                    # ↓↓↓ AGREGAR ESTO PARA CONECTAR CON EL BOTÓN INVISIBLE ↓↓↓
#                    **{"data-dash-click": '{"props_id":"nueva-prediccion"}'}),
#         html.Button("Finalizar predicción", id="finalizar-prediccion-visible", n_clicks=0, className="btn-accion", 
#                    # ↓↓↓ AGREGAR ESTO PARA CONECTAR CON EL BOTÓN INVISIBLE ↓↓↓
#                    **{"data-dash-click": '{"props_id":"finalizar-prediccion"}'})
...
#     # ↓↓↓ CAMBIO 1: Definir los botones directamente en el layout, no generados dinámicamente ↓↓↓
#     html.Div(id="resultado", className="resultado", style={"display": "none"}, children=[
#         html.Div(id="mensaje-resultado", className="mensaje-resultado"),
#         html.Div([
#             html.Button("Realizar una nueva predicción", id="nueva-prediccion", n_clicks=0, className="btn-accion"),
...
#     # ↓↓↓ CAMBIO 2: Modificar el mensaje de finalización ↓↓↓
#     html.Div(id="finalizacion", className="resultado", style={"display": "none"}, children=[
...
######################################
#####################################
################################## CAMBIO PARA GUARDADO DE BASE DE DATOS 
import dash
from dash import html, dcc, Input, Output, State, ctx
import joblib
import os
...
app.layout = html.Div([
    ...
    html.Div(id="bloque-medico", className="formulario-bloque bloque", children=[
        ...
        # ↓↓↓ CORREGIDO: Separar etiquetas y dropdowns correctamente ↓↓↓
        html.Label("Cáncer de piel"),  # ← Corregido
        dcc.Dropdown(
            id="cancer_piel", 
        ...
        html.Label("Otro cáncer"),  # ← Corregido
        dcc.Dropdown(
            id="otro_cancer", 
            options=[{"label": "Sí", "value": 1}, {"label": "No", "value": 0}],
            placeholder="Selecciona"
        ...
        html.Label("Depresión"),  # ← Corregido
        dcc.Dropdown(
            id="depresion", 
            options=[{"label": "Sí", "value": 1}, {"label": "No", "value": 0}],
            placeholder="Selecciona"
...
if __name__ == "__main__":
    logger.info("Iniciando aplicación HeartWise con análisis médico completo...")
    app.run(debug=True)