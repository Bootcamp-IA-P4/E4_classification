...
BACKEND_URL = "http://localhost:8050"  # Asegúrate que coincida con tu puerto FastAPI
...
def mostrar_resultado(n_clicks, altura, peso, imc, sexo, edad, alcohol, fruta, verduras, papas,
    ...
    datos = {
        ...
        "diabetes": diabetes,
        "artritis": artritis,
        "historial_tabaquismo": 0  # Valor por defecto
    }
    ...
    try:
        ...
        return html.Div([
            ...
            html.P(f"Riesgo: {'Alto' if resultado['prediction'] == 1 else 'Bajo'}", 
                  style={"color": riesgo_color}),
            html.P(mensaje)
        ]), str(datos)

    except requests.exceptions.RequestException as e:
        return html.Div(f"Error al conectar con el servidor: {str(e)}"), ""
